                ...
                <div class="change">
                    <form class="form-horizontal" action="/action" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" name="pirce" required="" placeholder="以物换物填写0" value="{{$order[0] -> price}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <textarea name="address" required="" value=''>{{$order[0] -> address}}</textarea>
                        </div>
                        </div>  
                        <center>
                            <button type="submit" class="btn btn-default center"> 确认修改</button>
                        </center>
